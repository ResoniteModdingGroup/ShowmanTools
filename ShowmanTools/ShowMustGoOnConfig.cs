...
namespace ShowmanTools
{
    internal sealed class ShowMustGoOnConfig : ConfigSection
    {
        ...
        private static readonly DefiningConfigKey<bool> _enableVoiceWhileUnfocused = new("EnableVoiceWhileUnfocused", "Keep streaming your voice to unfocused worlds.<br/>This setting can present a privacy risk - make sure to disable it after use.", () => false);
